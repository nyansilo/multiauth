                        ...
                        <div style="min-width: 600px">
                            ...
                            <main>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($cartItems as $cartItem)
                                            ...
                                            <tr>
                                                ...
                                                <td class="unit">{{ $cartItem->product->unit->name}}</td>
                                    ...
                                    <tfoot>
                                        <tr colspan="3">    
                                            <td colspan="3" class="text-left">Requested By:</td>
                                            <td colspan="3" class="text-right"></td>
                                        </tr>
 
                                        <tr colspan="3">   
                                            <td colspan="3" class="text-right">Postion:</td>
                                            <td colspan="3" class="text-left">{{ auth()->user()->position }}</td>
                                        </tr>
                                        <tr colspan="3">  
                                            <td colspan="3" class="text-right">Name:</td>
                                            <td colspan="3" class="text-left">{{ auth()->user()->fullName }}</td>
                                        </tr>

                                        <tr colspan="3">    
                                            <td colspan="3" class="text-right">Signature:</td>
                                            <td colspan="3" class="text-left">{{ substr(auth()->user()->first_name, 0,1) }}.{{ substr(auth()->user()->last_name,0,1) }}</td>
                                ...
                                <form  id="category-form"  method="POST" >
                                    ...
                                    <div class="col-md-12 ">
                                        <input type="hidden"  wire:model="user_sign" class="form-control" id="usersign"  >
                                    </div>
