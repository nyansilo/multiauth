		...
		<div class="card">
			...
			<div class="card-body p-4">
					...
					<div class="col-md-12  py-2 {{ $errors->has('bio') ? 'is-invalid' : '' }}">
						...
						id="bio" placeholder="Bio" >{{ old('bio')}}</textarea>
	...
	<div class="col-xl-4 mx-auto">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="col-md-12 py-2 {{ $errors->has('role') ? 'error' : '' }}">
					

					<select class="role form-control {{ $errors->has('role') ? 'error' : '' }} mb-3" aria-label="Default select example" name="role" id="role">
