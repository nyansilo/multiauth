...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
	...
	<div class="ms-auto">
		<div class="btn-group">
			...
			<a href="{{ route('admin.user.index')}}" class="btn btn-primary d-none d-sm-inline-block" type="button" class="btn btn-primary"> View All Category </a>
...
<hr/>
<div class="row">
	<form  id="category-form" class="row g-3" novalidate="" method="POST" action="{{ route('admin.user.update', $user->id )}}">
				...
				<div class="card-body p-4">
					...
					<div class="col-md-12 py-2 {{ $errors->has('first_name') ? 'is-invalid' : '' }}">
						...
						<input type="text"  name="first_name" class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}"
						 id="firstName"  placeholder="First Name" value="{{ $user->first_name }}"  >
					</div>
					...
					<div class="col-md-12 py-2 {{ $errors->has('last_name') ? 'is-invalid' : '' }}">
						...
						id="lastName" placeholder="Last Name" value="{{ $user->last_name }}"  >
					</div>
					...
					<div class="col-md-12  py-2 {{ $errors->has('phone_number') ? 'is-invalid' : '' }}">
						...
						id="phoneNumber" placeholder="Phone NUmber" value="{{ $user->phone_number }}" >
					</div>
