<table>
    ...
    <tbody>
        ...
        @foreach ($orderPMU->orderItems as $orderItem)
    ...
    <tfoot>
        ...
        <tr>
            ...
            <td class="text-left">{{ $orderPMU->user->position }}</td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-right">Name:</td>
            <td class="text-left"> {{ $orderPMU->user->fullName }}</td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-right">Signature:</td>
            <td class="text-left">{{ substr($orderPMU->user->first_name, 0,1) }}.{{ substr($orderPMU->user->last_name,0,1) }}</td>
        </tr>
