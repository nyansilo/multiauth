	...
	<div class="col-xl-12 mx-auto">
		<div class="card">
			...
			<div class="card-body p-4">
				...
				<form  id="category-form" class="row g-3" novalidate="" method="POST" action="{{ route('admin.unit.update', $unit->id )}}">
					...
					<div class="col-md-12 {{ $errors->has('slug') ? 'has-error' : '' }}">
						...
						<input type="text"  name="slug" class="form-control" id="slug" value= "{{ $unit->slug}}" >
					</div>
