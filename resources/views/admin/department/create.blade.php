	...
	<div class="col-xl-12 mx-auto">
		<div class="card">
			<div class="card-header px-4 py-3">
				<h5 class="mb-0">Add New Department Form</h5>
			</div>
			<div class="card-body p-4">

				
				<form  id="category-form" class="row g-3 needs-validation" novalidate="" method="POST" action="{{ route('admin.department.store')}}">
