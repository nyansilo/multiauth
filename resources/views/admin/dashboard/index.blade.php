<h2>Admin Dashboard </h2>@extends('layouts.admin.admin_layout')
...
<div class="page-content">
	...
	@include('admin.dashboard.admin_statistics')

	@endrole

	@role(['admin', 'pmu'])
		@include('admin.dashboard.pmu_statistics')
	@endrole	

	@role(['hod'])
		@include('admin.dashboard.hod_statistics')
	@endrole	
