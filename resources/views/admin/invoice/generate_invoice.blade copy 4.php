  ...
  <body>
    ...
    <main>
      ...
      <div id="client">
        ...
        <div></div>
        <h3 class="name">Position:</h3>  <h3>{{ $order->approver->job_title }}</h3>
        <h3 class="name">Name:      {{ $order->approver->fullName }} </h3>
        <h3 class="name">Signature: {{ $order->approver_sign }}</h3>
      </div>
      <div id="invoice">
        ...
        <table>
          <tbody>
              ...
              <tr>
                <td>Position: </td>
                <td> <h4>{{ $order->user->job_title }}</h4> </td>
              </tr>
              <tr>
                <td>Name: </td>
