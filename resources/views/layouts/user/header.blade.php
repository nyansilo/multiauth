				...
				<nav class="navbar navbar-expand gap-3">
					<div class="mobile-toggle-menu"><i class='bx bx-menu'></i>
					  ...
					  <div class="top-menu ms-auto">
						<ul class="navbar-nav align-items-center gap-1">
							...
							<li class="nav-item dropdown dropdown-large">
								<a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="{{ route('user.cart') }}" role="button" data-bs-toggle="dropdown" aria-expanded="false">
								...
								@livewire('user.cart.cart-model-component')
					...
					<div class="user-box dropdown px-3">
						...
						<a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							@if(!empty($current_user->profileUrl))
							...
							<div class="user-info">
								...
								<p class="designattion mb-0">{{ $current_user->position}}</p>
							</div>
						</a>
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li><a class="dropdown-item d-flex align-items-center" href="{{ route('user.dashboard') }}"><i class="bx bx-home-circle fs-5"></i><span>Dashboard</span></a>
							</li>
