...
class Unit extends Model
{
    ...
    /**
     * Set up ProductUnit - Product Relationship.
     * One PProductUnit has many Products
     */
     ...
     */
    public function unitNumber($label = 'unit')
    {
        $unitsNumber = $this->name->count();

        return $unitsNumber. " " . Str::plural($label, $unitsNumber);
    }
